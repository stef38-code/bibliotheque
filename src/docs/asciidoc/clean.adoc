...
public class ServiceImpl implements Service {
    ...
    public ServiceImpl(BaseDeDonnees baseDeDonnees) {
...
public class Service {
    ...
    public Service(BaseDeDonnees baseDeDonnees) {
        this.baseDeDonnees = baseDeDonnees;
    }
    public Livre trouverLivre(int id) {
        // Appeler la base de données pour trouver le livre
        return baseDeDonnees.trouverLivre(id);
    }
}
...
public class BaseDeDonneesImpl implements BaseDeDonnees {
    private JdbcTemplate jdbcTemplate;

    public BaseDeDonneesImpl(JdbcTemplate jdbcTemplate) {
