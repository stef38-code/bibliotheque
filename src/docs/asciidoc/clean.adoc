...
image::clean_nodepend_utilisateur_application.png[]

[source,java]
----
include::{sourcedir}/org/hussard/samples/clean/Controleur.java[]
----
[source,java]
----
include::{sourcedir}/org/hussard/samples/clean/Service.java[]
----
[source,java]
----
include::{sourcedir}/org/hussard/samples/clean/ServiceDefault.java[]
----
...
image::clean_nodepend_application_infrastructure.png[]
...
[source,java]
----
include::{sourcedir}/org/hussard/samples/clean/BaseDeDonnees.java[]
----
[source,java]
----
include::{sourcedir}/org/hussard/samples/clean/BaseDeDonneesDefault.java[]
----
...
===== Métier
image::clean_metier_structure.png[]

===== Application
image::clean_application_structure.png[]

===== Infrastructure
image::clean_infrastructure_structure.png[]
