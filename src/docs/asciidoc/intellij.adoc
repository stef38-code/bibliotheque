...
image::{imagesrep}/intellij_CustomPostfixTemplates_Menu.adoc.png[]
image::{imagesrep}/intellij_CustomPostfixTemplates_Menu_add.adoc.png[]
image::{imagesrep}/intellij_CustomPostfixTemplates_Menu_add_select.adoc.png[]
image::{imagesrep}/intellij_CustomPostfixTemplates_Menu_add_fileName.adoc.png[]
